...
<div id="{{ $name }}" x-data="{ show: false, name: '{{$name}}'}" x-show="show" x-on:modal.window="show = ($event.detail === name)" @keydown.escape.window="show = false" style="display: none;" {{ $attributes }}>
